...
public class Neo4JGraphModificationReviewerTest extends GraphModificationReviewerTest {
    ...
    public TestContext initTest() throws PMException {
        PAP pap = new PAP(new Neo4JPolicyModifier(embeddedDatabaseServer.defaultDatabaseService()), new Neo4jPolicyReviewer());
        return new TestContext(new Neo4jGraphReviewer(embeddedDatabaseServer.defaultDatabaseService()), pap.modify());
    }
}
