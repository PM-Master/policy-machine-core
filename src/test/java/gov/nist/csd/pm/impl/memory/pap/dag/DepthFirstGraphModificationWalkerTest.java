...
class DepthFirstGraphModificationWalkerTest {
    ...
    static void setup() throws PMException {
        ...
        pap.modify().graph().createObjectAttribute("oa1-1", new HashMap<>(), List.of("oa1"));
        pap.modify().graph().createObjectAttribute("oa1-1-1", new HashMap<>(), List.of("oa1-1"));
        pap.modify().graph().createObjectAttribute("oa1-1-2", new HashMap<>(), List.of("oa1-1"));
        pap.modify().graph().createObjectAttribute("oa1-1-3", new HashMap<>(), List.of("oa1-1"));

        pap.modify().graph().createObjectAttribute("oa1-2", new HashMap<>(), List.of("oa1"));
        pap.modify().graph().createObjectAttribute("oa1-2-1", new HashMap<>(), List.of("oa1-2"));
        pap.modify().graph().createObjectAttribute("oa1-2-2", new HashMap<>(), List.of("oa1-2"));
        pap.modify().graph().createObjectAttribute("oa1-2-3", new HashMap<>(), List.of("oa1-2"));
    }
