...
public abstract class AccessQuerierTest {
    ...
    void testComputeAccessibleChildren() throws PMException {
        ...
        List<String> actual = testCtx.pap().query().access().computeAccessibleChildren(new UserContext("u1"), "oa1");
        assertEquals(
                Set.of("oa2", "o1", "o2"),
                new HashSet<>(actual)
        );
    ...
    void testComputeAccessibleParents() throws PMException {
        ...
        List<String> actual = testCtx.pap().query().access().computeAccessibleParents(new UserContext("u1"), "o1");
        assertEquals(
                Set.of("oa1", "oa2"),
                new HashSet<>(actual)
        );
    ...
    void testGetChildren() throws PMException {
        ...
        String u1 = testCtx.pap().modify().graph().createUser("u1", new HashMap<>(), List.of(ua1));
        String o1 = testCtx.pap().modify().graph().createObject("o1", new HashMap<>(), List.of(oa1));
        String o2 = testCtx.pap().modify().graph().createObject("o2", new HashMap<>(), List.of(oa1));
        String o3 = testCtx.pap().modify().graph().createObject("o3", new HashMap<>(), List.of(oa1));
    ...
    class GetPrivilegesTests {
        ...
        void testGraph2() throws PMException {
            ...
            String pc1 = testCtx.pap().modify().graph().createPolicyClass("pc1", new HashMap<>());
            String pc2 = testCtx.pap().modify().graph().createPolicyClass("pc2", new HashMap<>());
            String ua1 = testCtx.pap().modify().graph().createUserAttribute("ua1", new HashMap<>(), List.of(pc1, pc2));
            ...
            String oa1 = testCtx.pap().modify().graph().createObjectAttribute("oa1", new HashMap<>(), List.of(pc1));
            String oa2 = testCtx.pap().modify().graph().createObjectAttribute("oa2", new HashMap<>(), List.of(pc2));
            String o1 = testCtx.pap().modify().graph().createObject("o1", new HashMap<>(), List.of(oa1, oa2));

            testCtx.pap().modify().graph().associate(ua1, oa1, new AccessRightSet("read"));


            assertTrue(testCtx.pap().query().access().computePrivileges(new UserContext(u1), o1).isEmpty());
        }
        ...
        void testGraph4() throws PMException {
            ...
            testCtx.pap().modify().graph().associate(ua1, oa1, new AccessRightSet("read"));
            testCtx.pap().modify().graph().associate(ua2, oa1, new AccessRightSet("write"));


            assertEquals(
                    new AccessRightSet("read", "write"),
                    testCtx.pap().query().access().computePrivileges(new UserContext(u1), o1)
            );
        }
        ...
        void testGraph5() throws PMException {
            ...
            String pc2 = testCtx.pap().modify().graph().createPolicyClass("pc2", new HashMap<>());
            String ua1 = testCtx.pap().modify().graph().createUserAttribute("ua1", new HashMap<>(), List.of(pc1));
            String ua2 = testCtx.pap().modify().graph().createUserAttribute("ua2", new HashMap<>(), List.of(pc2));
            String u1 = testCtx.pap().modify().graph().createUser("u1", new HashMap<>(), List.of(ua1, ua2));
            String oa1 = testCtx.pap().modify().graph().createObjectAttribute("oa1", new HashMap<>(), List.of(pc1));
            String oa2 = testCtx.pap().modify().graph().createObjectAttribute("oa2", new HashMap<>(), List.of(pc2));
            String o1 = testCtx.pap().modify().graph().createObject("o1", new HashMap<>(), List.of(oa1, oa2));
            ...
            testCtx.pap().modify().graph().associate(ua1, oa1, new AccessRightSet("read"));
            testCtx.pap().modify().graph().associate(ua2, oa2, new AccessRightSet("read", "write"));



            assertTrue(testCtx.pap().query().access().computePrivileges(new UserContext(u1), o1).containsAll(Arrays.asList("read")));
        }
        ...
        void testGraph6() throws PMException {
            ...
            testCtx.pap().modify().graph().associate(ua1, oa1, new AccessRightSet("read", "write"));
            testCtx.pap().modify().graph().associate(ua2, oa2, new AccessRightSet("read"));
        ...
        void testGraph8() throws PMException {
            ...
            testCtx.pap().modify().graph().associate(ua1, oa1, new AccessRightSet("*"));



            Set<String> list = testCtx.pap().query().access().computePrivileges(new UserContext(u1), o1);
        ...
        void testGraph9() throws PMException {
            ...
            testCtx.pap().modify().graph().associate(ua1, oa1, new AccessRightSet("*"));
            testCtx.pap().modify().graph().associate(ua2, oa1, new AccessRightSet("read", "write"));
        ...
        void testGraph11() throws PMException {
            ...
            assertEquals(new AccessRightSet(), testCtx.pap().query().access().computePrivileges(new UserContext(u1), o1));
        }
        ...
        void testGraph13() throws PMException {
            ...
            String pc1 = testCtx.pap().modify().graph().createPolicyClass("pc1", new HashMap<>());
            String ua2 = testCtx.pap().modify().graph().createUserAttribute("ua2", new HashMap<>(), List.of(pc1));
            String ua1 = testCtx.pap().modify().graph().createUserAttribute("ua1", new HashMap<>(), List.of(ua2));
            String u1 = testCtx.pap().modify().graph().createUser("u1", new HashMap<>(), List.of(ua1));
            String oa2 = testCtx.pap().modify().graph().createObjectAttribute("oa2", new HashMap<>(), List.of(pc1));
            String oa1 = testCtx.pap().modify().graph().createObjectAttribute("oa1", new HashMap<>(), List.of(oa2));
            String o1 = testCtx.pap().modify().graph().createObject("o1", new HashMap<>(), List.of(oa1));
        ...
        void testGraph14() throws PMException {
            ...
            String ua2 = testCtx.pap().modify().graph().createUserAttribute("ua2", new HashMap<>(), List.of(pc1));
            String u1 = testCtx.pap().modify().graph().createUser("u1", new HashMap<>(), List.of(ua1, ua2));
            String oa1 = testCtx.pap().modify().graph().createObjectAttribute("oa1", new HashMap<>(), List.of(pc1, pc2));
            String o1 = testCtx.pap().modify().graph().createObject("o1", new HashMap<>(), List.of(oa1));

            testCtx.pap().modify().graph().associate(ua1, oa1, new AccessRightSet("*"));
            testCtx.pap().modify().graph().associate(ua2, oa1, new AccessRightSet("*"));
        ...
        void testGraph18() throws PMException {
            ...
            String oa1 = testCtx.pap().modify().graph().createObjectAttribute("oa1", new HashMap<>(), List.of(pc1));
            String oa2 = testCtx.pap().modify().graph().createObjectAttribute("oa2", new HashMap<>(), List.of(pc1));
            String o1 = testCtx.pap().modify().graph().createObject("o1", new HashMap<>(), List.of(oa2));
        ...
        void testGraph19() throws PMException {
            ...
            String ua1 = testCtx.pap().modify().graph().createUserAttribute("ua1", new HashMap<>(), List.of(pc1));
            String ua2 = testCtx.pap().modify().graph().createUserAttribute("ua2", new HashMap<>(), List.of(pc1));
            String u1 = testCtx.pap().modify().graph().createUser("u1", new HashMap<>(), List.of(ua2));
            String oa1 = testCtx.pap().modify().graph().createObjectAttribute("oa1", new HashMap<>(), List.of(pc1));
            String o1 = testCtx.pap().modify().graph().createObject("o1", new HashMap<>(), List.of(oa1));
        ...
        void testGraph21() throws PMException {
            ...
            testCtx.pap().modify().graph().associate(ua1, oa1, new AccessRightSet("read"));
            testCtx.pap().modify().graph().associate(ua2, oa2, new AccessRightSet("write"));
        ...
        void testGraph23WithProhibitions() throws PMException {
            ...
            String ua1 = testCtx.pap().modify().graph().createUserAttribute("ua1", new HashMap<>(), List.of(pc1));
            String u1 = testCtx.pap().modify().graph().createUser("u1", new HashMap<>(), List.of(ua1));
            String oa3 = testCtx.pap().modify().graph().createObjectAttribute("oa3", new HashMap<>(), List.of(pc1));
            String oa4 = testCtx.pap().modify().graph().createObjectAttribute("oa4", new HashMap<>(), List.of(pc1));
            String oa2 = testCtx.pap().modify().graph().createObjectAttribute("oa2", new HashMap<>(), List.of(oa3));
            String oa1 = testCtx.pap().modify().graph().createObjectAttribute("oa1", new HashMap<>(), List.of(oa4));
            String o1 = testCtx.pap().modify().graph().createObject("o1", new HashMap<>(), List.of(oa1, oa2));
        ...
        void testGraph24WithProhibitions() throws PMException {
            ...
            String oa2 = testCtx.pap().modify().graph().createObjectAttribute("oa2", new HashMap<>(), List.of(pc1));
            String o1 = testCtx.pap().modify().graph().createObject("o1", new HashMap<>(), List.of(oa1, oa2));
            String o2 = testCtx.pap().modify().graph().createObject("o2", new HashMap<>(), List.of(oa2));
            ...
            assertTrue(testCtx.pap().query().access().computePrivileges(new UserContext(u1), o1).contains("read"));
            assertTrue(testCtx.pap().query().access().computePrivileges(new UserContext(u1), o2).isEmpty());
            ...
            assertEquals(
                    new AccessRightSet(),
                    testCtx.pap().query().access().computePrivileges(new UserContext(u1, "1234"), o1)
            );
        }
        ...
        void testGraph25WithProhibitions() throws PMException {
            ...
            String u1 = testCtx.pap().modify().graph().createUser("u1", new HashMap<>(), List.of(ua1));
            String oa1 = testCtx.pap().modify().graph().createObjectAttribute("oa1", new HashMap<>(), List.of(pc1));
            String oa2 = testCtx.pap().modify().graph().createObjectAttribute("oa2", new HashMap<>(), List.of(oa1));
            String oa3 = testCtx.pap().modify().graph().createObjectAttribute("oa3", new HashMap<>(), List.of(oa1));
            String oa4 = testCtx.pap().modify().graph().createObjectAttribute("oa4", new HashMap<>(), List.of(oa3));
            String oa5 = testCtx.pap().modify().graph().createObjectAttribute("oa5", new HashMap<>(), List.of(oa2));
            String o1 = testCtx.pap().modify().graph().createObject("o1", new HashMap<>(), List.of(oa4));
            ...
            assertTrue(testCtx.pap().query().access().computePrivileges(new UserContext(u1), oa5).isEmpty());
            assertTrue(
                    testCtx.pap().query().access().computePrivileges(new UserContext(u1), o1).containsAll(Arrays.asList("read", "write")));
        }
        ...
        void testProhibitionsAllCombinations() throws PMException {
            ...
            testCtx.pap().modify().graph().setResourceAccessRights(RWE);
            testCtx.pap().modify().graph().createPolicyClass("pc1", new HashMap<>());
            testCtx.pap().modify().graph().createObjectAttribute("oa1", new HashMap<>(), List.of("pc1"));
            testCtx.pap().modify().graph().createObjectAttribute("oa2", new HashMap<>(), List.of("pc1"));
            testCtx.pap().modify().graph().createObjectAttribute("oa3", new HashMap<>(), List.of("pc1"));
            testCtx.pap().modify().graph().createObjectAttribute("oa4", new HashMap<>(), List.of("pc1"));
            testCtx.pap().modify().graph().createObject("o1", new HashMap<>(), List.of("oa1", "oa2", "oa3"));
            testCtx.pap().modify().graph().createObject("o2", new HashMap<>(), List.of("oa1", "oa4"));

            testCtx.pap().modify().graph().createUserAttribute("ua1", new HashMap<>(), List.of("pc1"));
            testCtx.pap().modify().graph().createUser("u1", new HashMap<>(), List.of("ua1"));
            testCtx.pap().modify().graph().createUser("u2", new HashMap<>(), List.of("ua1"));
            testCtx.pap().modify().graph().createUser("u3", new HashMap<>(), List.of("ua1"));
            testCtx.pap().modify().graph().createUser("u4", new HashMap<>(), List.of("ua1"));
            ...
            list = testCtx.pap().query().access().computePrivileges(new UserContext("u1"), "o2");
            assertTrue(list.contains("read") && list.contains("write"));

            list = testCtx.pap().query().access().computePrivileges(new UserContext("u2"), "o2");
            assertTrue(list.contains("read") && !list.contains("write"));

            list = testCtx.pap().query().access().computePrivileges(new UserContext("u3"), "o2");
            assertTrue(list.contains("read") && !list.contains("write"));

            list = testCtx.pap().query().access().computePrivileges(new UserContext("u4"), "o1");
            assertTrue(list.contains("read") && !list.contains("write"));

            list = testCtx.pap().query().access().computePrivileges(new UserContext("u4"), "o2");
            assertTrue(list.contains("read") && !list.contains("write"));
        }
        ...
        void testPermissions() throws PMException {
            ...
            testCtx.pap().modify().graph().associate(ua1, oa1, allAccessRights());
            ...
            testCtx.pap().modify().graph().associate(ua1, oa1, allAdminAccessRights());
            list = testCtx.pap().query().access().computePrivileges(new UserContext("u1"), "o1");
            assertTrue(list.containsAll(allAdminAccessRights()));
            assertFalse(list.containsAll(RWE));

            testCtx.pap().modify().graph().associate(ua1, oa1, new AccessRightSet(ALL_RESOURCE_ACCESS_RIGHTS));
            list = testCtx.pap().query().access().computePrivileges(new UserContext("u1"), "o1");
        ...
        void testPermissionsInOnlyOnePC() throws PMException {
            ...
            testCtx.pap().modify().graph().setResourceAccessRights(RWE);
            testCtx.pap().modify().graph().createPolicyClass("pc1", new HashMap<>());
            testCtx.pap().modify().graph().createPolicyClass("pc2", new HashMap<>());
            testCtx.pap().modify().graph().createUserAttribute("ua3", new HashMap<>(), List.of("pc1"));
            testCtx.pap().modify().graph().createUserAttribute("ua2", new HashMap<>(), List.of("ua3"));
            testCtx.pap().modify().graph().createUserAttribute("u1", new HashMap<>(), List.of("ua2"));

            testCtx.pap().modify().graph().createObjectAttribute("oa1", new HashMap<>(), List.of("pc1"));
            testCtx.pap().modify().graph().createObjectAttribute("oa3", new HashMap<>(), List.of("pc2"));
            testCtx.pap().modify().graph().assign("oa3", "oa1");
            testCtx.pap().modify().graph().createObject("o1", new HashMap<>(), List.of("oa3"));

            testCtx.pap().modify().graph().associate("ua3", "oa1", new AccessRightSet("read"));
        ...
        void testProhibitionsWithContainerAsTarget() throws PMException {
            ...
            testCtx.pap().modify().graph().setResourceAccessRights(new AccessRightSet("read"));
            testCtx.pap().modify().graph().createPolicyClass("pc1", new HashMap<>());
            testCtx.pap().modify().graph().createUserAttribute("ua1", new HashMap<>(), List.of("pc1"));
            testCtx.pap().modify().graph().createObjectAttribute("oa1", new HashMap<>(), List.of("pc1"));
            testCtx.pap().modify().graph().createUser("u1", new HashMap<>(), List.of("ua1"));
            ...
            testCtx.pap().modify().prohibitions().create("deny1", ProhibitionSubject.user("u1"), new AccessRightSet("read"), false,
                                         new ContainerCondition("oa1", false)
            );


            AccessRightSet deniedAccessRights = testCtx.pap().query().access().computeDeniedPrivileges(new UserContext("u1"), "oa1");
