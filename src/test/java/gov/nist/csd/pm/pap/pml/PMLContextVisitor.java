...
public class PMLContextVisitor extends PMLParserBaseVisitor<RuleContext> {
    ...
    @Override
    public RuleContext visitSetResourceAccessRightsStatement(PMLParser.SetResourceAccessRightsStatementContext ctx) {
        return ctx;
    }
    ...
    @Override
    public RuleContext visitConstDeclaration(PMLParser.ConstDeclarationContext ctx) {
        return ctx;
    }
