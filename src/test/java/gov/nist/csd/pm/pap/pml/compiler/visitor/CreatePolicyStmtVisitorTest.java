...
class CreatePolicyStmtVisitorTest {
    ...
    void testHierarchyUserAttributesOnly() throws PMException {
        ...
        CompiledPML compiledPML = PMLCompiler.compilePML(pap, pml);
    ...
    void testMalformedProperty() throws PMException {
        ...
        PMLCompilationException e = assertThrows(
                PMLCompilationException.class, () -> PMLCompiler.compilePML(pap, pml));
    ...
    void testHierarchyWithInvalidIndentation() throws PMException {
        ...
        String pml2 = """
                ...
                """;
        e = assertThrows(
                PMLCompilationException.class, () -> PMLCompiler.compilePML(pap, pml2));
        ...
        String pml3 = """
                ...
                """;
        e = assertThrows(
                PMLCompilationException.class, () -> PMLCompiler.compilePML(pap, pml3));
