...
class FunctionInvokeExpressionTest {
    ...
    void testVoidReturnType() throws PMException {
        ...
        VisitorContext visitorContext = new VisitorContext(new CompileGlobalScope()
                                                                      .withFunctions(Map.of(voidFunc.getSignature().getFunctionName(), voidFunc.getSignature())));
        ...
        ExecutionContext executionContext = new ExecutionContext(new UserContext(""), new ExecuteGlobalScope()
                                                                                                 .withFunctions(Map.of(voidFunc.getSignature().getFunctionName(), voidFunc)));
    ...
    void testExecuteReturnValue() throws PMException {
        ...
        PMLParser.FunctionInvokeExpressionContext ctx = PMLContextVisitor.toExpressionCtx(
                ...
                """, PMLParser.FunctionInvokeExpressionContext.class);
        VisitorContext visitorContext = new VisitorContext(new CompileGlobalScope()
                                                                      .withFunctions(Map.of(stringFunc.getSignature().getFunctionName(), stringFunc.getSignature())));
    ...
    void testExecuteWithFunctionExecutor() throws PMException {
        ...
        ExecutionContext executionContext =
                new ExecutionContext(
                        new UserContext(""),
                        new ExecuteGlobalScope()
                                   .withFunctions(Map.of(stringFunc.getSignature().getFunctionName(), stringFunc))
                );
    ...
    void testChainMethodCall() throws PMException {
        String pml = """
                ...
                """;
        PAP pap = new MemoryPAP();
        new PMLExecutor().compileAndExecutePML(pap, new UserContext(), pml);
