...
public class CreateProhibitionStatement extends OperationStatement {
    ...
    public boolean equals(Object o) {
        ...
        return isIntersection == that.isIntersection && Objects.equals(
                name,
                that.name
        ) && Objects.equals(subject, that.subject) && subjectType == that.subjectType && Objects.equals(
                accessRights,
                that.accessRights
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), name, subject, subjectType, accessRights, isIntersection, containers);
    }
