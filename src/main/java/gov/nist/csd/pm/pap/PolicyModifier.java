 ...
 * any subclass calls {@link AdminPolicy#verify(AdminPolicy.Verifier, GraphModification)} in the constructor to verify the setup
 * of the admin policy.
 */
public abstract class PolicyModifier implements PolicyModification, Transactional {

    @Override
    public abstract GraphModification graph();

    @Override
    public abstract ProhibitionsModification prohibitions();

    @Override
    public abstract ObligationsModification obligations();

    @Override
    public abstract PMLModification pml();

    /**
     * Reset the underlying policy. This method should call {@link AdminPolicy#verify(AdminPolicy.Verifier, GraphModification)}
