...
public class DescendantOfPattern extends PMLPattern {
    public DescendantOfPattern(String varName, List<Value> argValues,
                               List<PMLPatternReqCap> capMap) throws PMException {
