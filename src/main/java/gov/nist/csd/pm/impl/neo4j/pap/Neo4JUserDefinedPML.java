...
import static gov.nist.csd.pm.impl.neo4j.pap.Neo4JObligations.BYTES_PROPERTY;

public class Neo4JUserDefinedPML implements UserDefinedPML {
    ...
    public Neo4JUserDefinedPML(Neo4jConnection neo4j) {
        this.neo4j = neo4j;
    }
