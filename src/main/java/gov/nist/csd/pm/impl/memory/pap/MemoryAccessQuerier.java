...
public class MemoryAccessQuerier extends AccessQuerier {
    ...
    public MemoryAccessQuerier(MemoryGraphQuerier graphQuerier, ProhibitionsQuerier prohibitionsQuerier) {
    ...
    public AccessRightSet computePrivileges(UserContext userCtx, String target) throws PMException  {
        ...
        return resolvePrivileges(userDagResult, targetDagResult, target, graphQuerier.getResourceAccessRights());
    }
    ...
    public Explain explain(UserContext userCtx, String target) throws PMException {
        ...
        Map<String, PolicyClass> resolvedPaths = resolvePaths(graphQuerier, userPaths, targetPaths, target);

        UserDagResult userDagResult = processUserDAG(userCtx.getUser(), userCtx.getProcess());
        TargetDagResult targetDagResult = processTargetDAG(target, userDagResult);

        AccessRightSet priv = resolvePrivileges(userDagResult, targetDagResult, target, graphQuerier.getResourceAccessRights());
    ...
    private void getAndStorePrivileges(Map<String, AccessRightSet> arsetMap, UserDagResult userDagResult, String target) throws PMException {
        ...
        AccessRightSet privileges = resolvePrivileges(userDagResult, targetCtx, target, graphQuerier.getResourceAccessRights());
    ...
    protected UserDagResult processUserDAG(String subject, String process) throws PMException  {
        ...
        final Set<Prohibition> reachedProhibitions = new HashSet<>(prohibitionsQuerier.getWithSubject(process));
     ...
     */
    public static Map<String, PolicyClass> resolvePaths(MemoryGraphQuerier graphQuerier, List<EdgePath> userPaths, List<EdgePath> targetPaths, String target) throws PMException {
    ...
    public static boolean isPolicyClass(MemoryGraphQuerier graphQuerier, String node) throws PMException {
