...
import static gov.nist.csd.pm.common.graph.nodes.Properties.WILDCARD;

class MemoryGraph extends MemoryStore<TxGraph> implements Graph, Transactional, BaseMemoryTx {
    ...
    private MemoryProhibitions memoryProhibitionsStore;
    private MemoryObligations memoryObligationsStore;
    ...
    public void setMemoryProhibitions(MemoryProhibitions memoryProhibitionsStore) {
        this.memoryProhibitionsStore = memoryProhibitionsStore;
    }

    public void setMemoryObligations(MemoryObligations memoryObligationsStore) {
