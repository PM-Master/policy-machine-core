...
class TxGraphModification implements GraphModification, BaseMemoryTx {

    private final TxOpTracker txOpTracker;
    private final MemoryGraphModification memoryGraphStore;

    public TxGraphModification(TxOpTracker txOpTracker, MemoryGraphModification memoryGraphStore) {
    ...
    public void rollback() {
        ...
        for (Operation event : events) {
            try {
                TxCmd<MemoryGraphModification> txCmd = (TxCmd<MemoryGraphModification>) TxCmd.eventToCmd(event);
