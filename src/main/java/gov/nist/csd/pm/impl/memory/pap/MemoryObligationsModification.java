...
class MemoryObligationsModification extends MemoryStore<TxObligationsModification> implements ObligationsModification, Transactional, BaseMemoryTx {

    private List<Obligation> obligations;
    private MemoryGraphModification graph;

    public MemoryObligationsModification() {
    ...
    public void beginTx() {
        if (tx == null) {
            tx = new MemoryTx<>(false, 0, new TxObligationsModification(new TxOpTracker(), this));
        }
