...
public class Neo4JProhibitions implements Prohibitions {
    ...
    public Neo4JProhibitions(Neo4jConnection neo4j) {
        this.neo4j = neo4j;
    }
    ...
    public void update(String name, ProhibitionSubject subject, AccessRightSet accessRights, boolean intersection,
        ...
        try {
            neo4j.runTx(tx -> {
                checkUpdateInput(new Neo4JGraph(neo4j), name, subject, accessRights, intersection, containerConditions);
