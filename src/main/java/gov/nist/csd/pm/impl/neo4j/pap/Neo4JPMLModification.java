...
import static gov.nist.csd.pm.impl.neo4j.pap.Neo4JObligationsModification.BYTES_PROPERTY;

public class Neo4JPMLModification implements PMLModification {
    ...
    public Neo4JPMLModification(Neo4jConnection neo4j) {
        this.neo4j = neo4j;
    }
