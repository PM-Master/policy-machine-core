...
public class AdjudicatorPMLModification implements PMLModification {
    private final UserContext userCtx;
    private final PAP pap;
    private final PrivilegeChecker privilegeChecker;

    public AdjudicatorPMLModification(UserContext userCtx, PAP pap, PrivilegeChecker privilegeChecker) {
