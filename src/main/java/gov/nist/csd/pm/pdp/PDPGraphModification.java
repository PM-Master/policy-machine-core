...
class PDPGraphModification implements GraphModification, EventEmitter {
    ...
    public PDPGraphModification(UserContext userCtx, AdjudicatorGraphModification adjudicator, PAP pap, EventProcessor listener) {
