...
class PDPProhibitionsModifier implements ProhibitionsModification, EventEmitter {
    private UserContext userCtx;
    private AdjudicatorProhibitionsModification adjudicator;
    private PAP pap;
    private EventProcessor listener;

    public PDPProhibitionsModifier(UserContext userCtx, AdjudicatorProhibitionsModification adjudicator, PAP pap, EventProcessor listener) {
